...
|
*/
$config['base_url']	= 'http://'.$_SERVER['HTTP_HOST'].'/dynamis-projects/GitFacturaElectronica/';
...
|
*/
$config['encryption_key'] = 'r4u7x!A%D*G-JaNdRgUkXp2s5v8y/B?E(H+MbPeShVmYq3t6w9z$C&F)J@NcRfTj';
